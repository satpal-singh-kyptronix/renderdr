...
const io = new Server(server, {
  cors: {
    origin: ["https://wonderful-liger-9ebf7c.netlify.app","https://ensembledemospace.com"],  // Allow all origins for development
    methods: ["GET", "POST"],
    credentials: true
  }
});
...
app.use(cors({
  origin:  ["https://wonderful-liger-9ebf7c.netlify.app","https://ensembledemospace.com"], // Match frontend URL
